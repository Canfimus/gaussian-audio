...
print("Summary:")
print("="*80)
print("If PESQ > 4.5 is observed:")
print("  1. Check if signals are being compared in wrong order")
print("  2. Check if signals are being normalized incorrectly")
print("  3. Check if baseline calculation is averaging wrong values")
print("  4. Verify the pesq library is installed correctly")
